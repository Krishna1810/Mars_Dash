...
namespace Mars_Dash.Mars_Pages
{
    class Mars_BasicProfile
    {
        ...
        public void LanguageInformation(IWebDriver driver)
        {
            ...
            WaitHelper.Waitvisible(driver, "XPath", "//div[@class='row']//form[@class='ui form']//div[@class='ui top attached tabular menu']//a[text()='Languages']");
            ...
            //WaitHelper.Waitvisible(driver, "XPath", "//td[text()='English']//parent::tr//following-sibling::td[@class='right aligned']//span[@class='button']/i[@class='outline write icon']");
            Thread.Sleep(2000);
            ...
            driver.FindElement(By.XPath("//select[@name='level']")).Click();
            driver.FindElement(By.XPath("//select[@name='level']//option[@value='Basic']")).Click();
            WaitHelper.Waitvisible(driver,"XPath", "//input[@value='Add']");
        ...
        public void SkillInformation(IWebDriver driver)
        {
            ...
            new WebDriverWait(driver,TimeSpan.FromSeconds(25)).Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.XPath("//td[text()='Testing']//parent::tr//following-sibling::td[@class='right aligned']//span[@class='button']//i[@class='outline write icon']")));
